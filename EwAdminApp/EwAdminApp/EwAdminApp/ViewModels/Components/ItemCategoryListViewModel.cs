    ...
    public ItemCategoryListViewModel()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.WhenAnyValue(x => x.SelectedItemCategory)
                .Subscribe(itemCategory => { MessageBus.Current.SendMessage(new ItemCategoryEvent(itemCategory)); })
                .DisposeWith(disposables);
            ...
            MessageBus.Current.Listen<WebAdminBrandEvent>()
                .Subscribe(brandMasterEvent =>
                {
                    ...
                    Console.WriteLine(
                        $"{GetType().Name}: BrandMasterEvent received: {brandMasterEvent.BrandMessage?.BrandId}");
