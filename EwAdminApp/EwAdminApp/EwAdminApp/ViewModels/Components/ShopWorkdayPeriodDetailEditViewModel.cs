...
public class ShopWorkdayPeriodDetailEditViewModel : ViewModelBase
{
    ...
    public ShopWorkdayPeriodDetailEditViewModel()
    {
        ...
        MessageBus.Current.Listen<ShopWorkdayPeriodDetailEvent>()
            .Subscribe(shopWorkdayPeriodDetailEvent =>
            {
                ...
                var serializedShopWorkdayPeriodDetail = JsonSerializer.Serialize(shopWorkdayPeriodDetailEvent.ShopWorkdayPeriodDetailMessage);
                SelectedShopWorkdayPeriodDetailClone = JsonSerializer.Deserialize<ShopWorkdayPeriodDetail>(serializedShopWorkdayPeriodDetail);
    ...
    private async Task DoSave()
    {
        try
        {
            ...
            // API URL: https://localhost:7045/api/PosAdmin/updateShopWorkdayPeriodDetail
            ...
            var request = new HttpRequestMessage(HttpMethod.Patch, "https://localhost:7045/api/PosAdmin/updateShopWorkdayPeriodDetail")
            {
                Content = new StringContent(JsonSerializer.Serialize(requeestShopWorkdayPeriodDetail), System.Text.Encoding.UTF8, "application/json")
            };
            ...
            var resultShopWorkdayPeriodDetail = JsonSerializer.Deserialize<ShopWorkdayPeriodDetail>(content, new System.Text.Json.JsonSerializerOptions
            {
    ...
    private Task DoCancel()
    {
        ...
        var selectedShopWorkdayPeriodDetailCloneObj = JsonSerializer.Deserialize<ShopWorkdayPeriodDetail>(selectedShopWorkdayPeriodDetailCloneJson);
